...
instance ItRu_PalLight(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalLight;
...
instance ItRu_PalLightHeal(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalLightHeal;
	text[2]						= NAME_HealingPerCast;							count[2] = SPL_Heal_PalLightHeal;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
};
...
instance ItRu_PalMediumHeal(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalMediumHeal;
	text[2]						= NAME_HealingPerCast;							count[2] = SPL_Heal_PalMediumHeal;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
};
...
instance ItRu_PalFullHeal(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalFullHeal;
	text[2]						= NAME_HealingPerCast;							count[2] = SPL_Heal_PalFullHeal;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
};
...
instance ItRu_PalHolyBolt(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalHolyBolt;
	text[2]						= NAME_Dam_Magic;								count[2] = SPL_Damage_PalHolyBolt;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
};
...
instance ItRu_PalRepelEvil(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalRepelEvil;
	text[2]						= NAME_Dam_Magic;								count[2] = SPL_Damage_PalRepelEvil;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
};
...
instance ItRu_PalDestroyEvil(C_Item)
{
	...
	text[0]						= Name_PaladinSpell;							count[0] = 0;
	text[1]						= NAME_Manakosten;								count[1] = SPL_Cost_PalDestroyEvil;
	text[2]						= NAME_Dam_Magic;								count[2] = SPL_Damage_PalDestroyEvil;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
};
